            ...
            <form action="{{ $form_url }}" class="row form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" class="form-control{{ $errors->has('no_of_subscription_accounts') ? ' is-invalid' : '' }}" name="no_of_subscription_accounts" value="{{ old("no_of_subscription_accounts") ?? $advisor->no_of_subscription_accounts }}" readonly >
                    </div>
                </div>
