            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ">
                    <div class="form-group">
                        ...
                        <select name="primary_region_id" class="form-control select2" required >
                            <option value="">Select Primary Region</option>
                            @foreach ($reasons as $reason)
                                <option value="{{ $reason->id }}" {{ isset($data->primary_region_id) && $reason->id == $data->primary_region_id ? "selected" : Null }}>{{ $reason->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 ">
                    <div class="form-group">
                        ...
                        <input type="text"  name="short_name" value="{{ $data->short_name ?? "" }}" class="form-control" required >
                    </div>
                </div>
