            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ">
                    <div class="form-group">
                        <label>Fund Size Name<span class="text-danger">*</span> </label>
                ...
                <div class="col-12 col-sm-6 ">
                    <div class="form-group">
                        <label>Min Fund Amount<span class="text-danger">*</span> </label>                               
                        <input type="number"  name="min_fund" value="{{ $data->min_fund ?? 0 }}" class="form-control" required >
                    </div>
                </div>
