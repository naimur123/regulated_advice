<div class="modal-content">            
    <div class="modal-header">
        <h5 class="modal-title" > {{ $title ?? "Add / Update Information" }} </h5>
                ...
                <div class="col-12 col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="type" class="form-control" required >
                            ...
                            <option value="area_of_advice" {{ isset($data->type) && $data->type == "area_of_advice" ? 'selected' : Null }} >Area of Advice</option>
                            <option value="others" {{ isset($data->type) && $data->type == "others" ? 'selected' : Null }} >Others</option>
                        </select>     
                    </div>
                </div>
