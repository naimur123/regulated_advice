            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 ">
                    <div class="form-group">
                        <label>Person Range Min<span class="text-danger">*</span> </label>
                        <input type="hidden" name="id" value="{{ isset($data->id) ? $data->id : 0 }}" >                                
                        <input type="number"  name="min_range" value="{{ $data->min_range ?? 0 }}" class="form-control" required >
                    </div>
                </div>
                <!-- First Name -->
                <div class="col-12 col-sm-6 ">
                    <div class="form-group">
                        <label>Person Range Mix<span class="text-danger">*</span> </label>
                        <input type="hidden" name="id" value="{{ isset($data->id) ? $data->id : 0 }}" >                                
                        <input type="number"  name="max_range" value="{{ $data->max_range ?? 0 }}" class="form-control" required >
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-12">
                    <div class="form-group">
                        <label>Amount</label> 
                        <input type="number" class="form-control" name="amount" value="{{ $data->amount ?? 0 }}">      
                    </div>                        
                </div>
