            ...
            <div class="row">
                ...
                <div class="col-12 ">
                    <div class="form-group">
                        <label>Serial position <span class="text-danger">*</span> </label>   
                        <input type="text" name="faq_sl" class="form-control" value="{{ old("faq_sl") ?? ($data->faq_sl ?? "") }}" required >
                    </div>
                </div>   
                ...
                <div class="col-12 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="question" class="form-control" value="{{ old("question") ?? ($data->question ?? "") }}" required >
                    </div>
                </div>                
                ...
                <div class="col-12 col-sm-12">
                    <div class="form-group">
                        <label>Answer</label>                                
                        <textarea name="answer" class="form-control editor" >{{ $data->answer ?? null }}</textarea>
                    </div>                        
                </div>
